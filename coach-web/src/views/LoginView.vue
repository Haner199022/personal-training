    ...
    <div class="login-right">
      <div class="card login-card">
        ...
        <el-form @submit.prevent="onSubmit">
          <el-form-item><el-input v-model="phone" size="large" placeholder="手机号" /></el-form-item>
          <el-form-item><el-input v-model="password" type="password" size="large" placeholder="密码" show-password /></el-form-item>
        ...
        <div class="caption" style="margin-top:8px">还没有账号？<RouterLink to="/register" style="color:var(--c-brand)">注册 →</RouterLink></div>
      </div>
    </div>
  </div>
</template>
...
.login-left { padding: 80px 64px; display: flex; flex-direction: column; justify-content: center; background: var(--c-bg) var(--gradient-brand-glow) no-repeat; border-right: 1px solid var(--c-border); }
